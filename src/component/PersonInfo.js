  ...
  return (
    <div className="wrap">
      ...
      <div className="profile">
       ...
       <div style={{ position: "absolute", width: "230px", height: "260px", marginLeft: "40px", marginTop: "67px" }}>
          <img className="profilephoto" src={resultImage}></img>
        </div>
      <div className="profiletxt">
        <br></br> <br></br>
        <div style={{ align : "left",marginLeft: "470px", marginTop: "-50px" }}>
          <p>{resultText} <br></br>{resultText2} <br></br>{resultText3}<br></br> {resultText4}<br></br>{ resultText5}</p>
      </div>
      </div>
    </div>
  );
